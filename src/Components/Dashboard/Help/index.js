...
const Help = ({ showHelp }) => {
  ...
  return (
    <div className="help">
      ...
      <p>
        The first parameters are the Patient Health Status.
        You can type one or more parameter separated by coma. The possible parameters are:
      </p>
      <ul>
      ...
      <h4>Drugs</h4>
      <p>
        In the “Hospital simulator” drugs are provided to all patients.
        It is not possible to target a specific patient. This is the list of available drugs:
      </p>
      <ul>
      ...
      <ul>
        ...
        <li>
          Drugs can change patients’ states.
          They can cure, cause side effects or even kill a patient if not properly prescribed.
        </li>
        <li>
